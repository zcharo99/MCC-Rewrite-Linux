...
\033[1;31m[\033[1;39m4.17\033[1;31m] \033[1;32mVape Client \033[1;31m[\033[1;33mv4.17\033[1;31m]  
...
"""
  ...
  while True:
    ...
    if chon == '-':
          ...
          webbrowser.open_new("https://johnspecial.ydns.eu/vape4.16")
    elif chon == '4.12':
