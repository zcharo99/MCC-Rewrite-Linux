...
\033[1;31m[\033[1;39m6.1.30A\033[1;31m] \033[1;32mRise 6.1.30 \033[1;31m[\033[1;33m1.6.2024 Update\033[1;31m] 
\033[1;97m= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
  """
  ...
  while True:
        ...
        if chon == '-':
            ...
            webbrowser.open_new("https://cdn.discordapp.com/attachments/1117810045124608020/1137702143734841434/Rise_v6.0.17.rar")
        elif chon == '6.0.18':
            webbrowser.open_new("https://www.mediafire.com/file/6c9orbvskr1w8yw/Rise.zip/file")
        elif chon == '6.0.20':
            webbrowser.open_new("https://cdn.discordapp.com/attachments/1136245960494813327/1145752996689481829/Rise_v6.0.20.zip")
        elif chon == '6.0.22':
            ...
            webbrowser.open_new("https://www.mediafire.com/file/2bfnhb4kmrgdn3a/Rise+v6.zip/file")
        else:
            continue
